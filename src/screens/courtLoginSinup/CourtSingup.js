...
const Sigup = ({ navigation }) => {
    ...
    return (
        <ScrollView style={styles.form} showsVerticalScrollIndicator={false} showsHorizontalScrollIndicator={false}>
            ...
            <Text style={styles.heading}>Sign Up Court Owner</Text>
            ...
            <View style={styles.SinupText}>
                ...
                <TouchableOpacity style={styles.linkText}>
                    <Text style={styles.informationTextAccont}>Already have an account?  <Text style={styles.TextLink} onPress={() => navigation.navigate('CourtLogin')} >Sign In!</Text> </Text>
                </TouchableOpacity>
            </View>
        </ScrollView>
    );
